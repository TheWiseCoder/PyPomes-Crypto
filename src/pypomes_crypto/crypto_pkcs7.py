...
class CryptoPkcs7:
    ...
    def __init__(self,
        ...
        *doc_data* (*detached* mode), it is validated against its declared hash value.
        ...
        signer_infos: list[cms.SignerInfo] = signed_data["signer_infos"] if not curr_errors else []
    ...
    def sign(doc_in: BytesIO | Path | str | bytes,
        ...
        :param p7s_out: path or byte stream to output the PKCS#7 file (optional, no output if not provided)
        ...
        if cert_main and private_key and sig_hasher:
            ...
            if not curr_errors:
                ...
                if not curr_errors:
                    ...
                    elif isinstance(p7s_out, BytesIO):
